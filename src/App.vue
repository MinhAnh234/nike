<template>
  <div id="app">    
            ...
            <main>
                    <router-view name="title_active"></router-view>
                    <div class="row">
                      <router-view name="title"></router-view>
                        <router-view name="left_main"></router-view>
                        <router-view/>
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <ul class="first-footer">
                            ...
                            <li><a href="">BECOME A NEMBER</a></li>
                    ...
                    <div class="col-lg-2">
                        <ul>
                            <li><a id="get-help" href="">GET HELP</a></li>
...
export default {
  name: 'App',
  components: {
    Header,Title,LeftMain,Products,LoginForm
  }, data() {
      return {
          allProducts:[],
      }
   ...
   mounted() {
    ...
    function myFunction() {
        if (window.pageYOffset-100> sticky) {
            leftMain.classList.add("sticky");
            title.style.display="block";
        } else {
            leftMain.classList.remove("sticky");
    ...
    $(window).scroll(function() {
           if($(window).scrollTop() + $(window).height() == getDocHeight()) {
            $('#left__menu__content').css('max-height',65+'%');
           }
           else {
            $('#left__menu__content').css('max-height',100+'%');
           }
    });
  }
}
